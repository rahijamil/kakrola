          ...
          <>
            {screenWidth > 768 || !mobileBottomSheet ? (
              <motion.div
                ...
                className={`z-50 bg-white/70 dark:bg-[#1f1f1f]/70 backdrop-blur-lg shadow-[2px_2px_.5rem_0px_rgba(0,0,0,0.2)] rounded-lg fixed ${
      ...
      {isOpen && (
        <motion.div
          ...
          className={`fixed inset-0 z-20 ${
            screenWidth <= 768 && mobileBottomSheet && "bg-black bg-opacity-60"
          }`}
          onClick={(ev) => {
            ev.stopPropagation();
            setIsOpen(false);
