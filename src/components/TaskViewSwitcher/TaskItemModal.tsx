      ...
      <div className="flex h-full">
        <div className="flex gap-1 bg-white p-4 flex-1">
          <div
            ...
            className="hover:bg-gray-100 transition rounded-md p-1 group h-fit"
          >
            <div
              className={`border border-gray-400 w-5 h-5 rounded-full flex items-center justify-center mt-1 ${
            ...
            <div className="mt-6">
              ...
              {showAddSubtask && (
                <div className="rounded-lg border border-gray-200 focus-within:border-gray-400 bg-white">
                  <AddTaskForm onClose={() => setShowAddSubtask(false)} />
                </div>
              )}
            </div>
