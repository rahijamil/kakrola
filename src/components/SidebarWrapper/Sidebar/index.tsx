...
import TeamspaceForSidebar from "./TeamspaceForSidebar";
    ...
    <>
      <aside className="h-full flex flex-col w-full select-none">
        ...
        <nav className="flex-grow overflow-y-auto space-y-4 ">
          <ul id="joyride_sidebar_menu_items">
            {menuItems
              .filter((item) =>
                screenWidth > 768
                  ? item.text != "Templates"
