...
const ShareOption = ({ onClose }: { onClose: () => void }) => {
  return (
    <>
      <div className="absolute bg-surface shadow-[2px_2px_8px_0px_rgba(0,0,0,0.2)] rounded-lg border border-text-200 p-4 w-[500px] top-11 right-5 z-20">
        <Input
          placeholder="Add people by name or email"
          type="text"
          className="border border-text-200 focus:border-text-400 rounded-lg px-2"
        />
