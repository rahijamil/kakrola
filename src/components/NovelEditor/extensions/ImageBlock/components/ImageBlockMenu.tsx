...
import { MenuProps } from "@/components/NovelEditor/menus/types";
import { useEditor } from "novel";
import getRenderContainer from "@/components/NovelEditor/utils";
import { Toolbar } from "@/components/NovelEditor/EditorUI/Toolbar";
import { Icon } from "@/components/NovelEditor/EditorUI/icons";

export const ImageBlockMenu = ({ appendTo }: MenuProps) => {
