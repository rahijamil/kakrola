...
const ImportCSVModal = ({ onClose }: { onClose: () => void }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-md p-4 pb-6 space-y-6 w-[420px] whitespace-normal"
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="p-1 hover:bg-gray-200 transition rounded-md"
          >
            <X strokeWidth={1.5} size={20} />
          </button>
        </div>

        <div className="border border-dashed border-gray-500 rounded-md space-y-6 p-10 flex flex-col items-center justify-center">
